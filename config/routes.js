...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'GET /coach/json': 'CoachController.json',
  ...
  'GET /admin/course/application': 'AdminController.applyList',
  'GET /admin/user': 'AdminController.user_list',
  'GET /admin/certificate':'AdminController.certApplication',
  // 'POST /admin/certificate':'AdminController.certApplication',
  '/admin/certificate/all':'AdminController.showall',
  

  'GET /admin/course/list': 'AdminController.allCourseSearch',
  'POST /admin/course/list': 'AdminController.allCourseSearch',
  '/scoreSheet/:id':'AdminController.scoreSheet',
  '/attendanceSheet/:id':'AdminController.attendanceSheet',

  'GET /admin/course/grade': 'AdminController.listGrade',
  'POST /admin/course/grade': 'AdminController.listGrade',
  'GET /admin/course/grade/:id': 'AdminController.reviewGrade',
  'POST /admin/course/verified/:id': 'AdminController.verified',
  'POST /admin/course/reject/:id': 'AdminController.reject',
  'GET /admin/course/mark/:id': 'AdminController.reviewMarkSheet',
  'GET /admin/course/attendance/:id': 'AdminController.reviewAttSheet',
  

  '/course/import_xlsx': 'AdminController.import_course_xlsx',
  '/course/export_xlsx': 'AdminController.export_course_xlsx',

  //'GET /admin/course/grade': 'AdminController.listGrade',
  //'GET /admin/course/:id/grade': 'AdminController.reviewGrade',
  //'POST /admin/course/:id/grade': 'AdminController.reviewGrade',
  'GET /admin/course/:id/applicant': 'AdminController.applicationHandler',
  'POST /admin/course/:id/applicant': 'AdminController.applicationHandler',
  
  //********************Course routes****************
  'GET /course/create': 'CourseController.create',
  'POST /course/create': 'CourseController.create',
  'GET /course/json': 'CourseController.json',
  // 'GET /course/list': 'CourseController.search',
  'GET /course': 'CourseController.search',
  'GET /course/read/:id': 'CourseController.read',
  'GET /course/:id': 'CourseController.read',
  'GET /course/update/:id': 'CourseController.update',
  'POST /course/update/:id': 'CourseController.update',
  'POST /course/delete/:id': 'CourseController.delete',
  

  //********************Application routes****************//
  'GET /course/:id/application': 'ApplicationController.apply',
  'POST /course/:id/application': 'ApplicationController.apply',
  'GET /application/json': 'ApplicationController.json',
  'GET /application/json2': 'ApplicationController.json2',
  'GET /admin/application/:id/edit' : 'ApplicationController.adminEdit',
  'POST /admin/application/:id/edit' : 'ApplicationController.adminEdit',

  //********************User routes****************//
  'GET /user/application': 'UserController.applylist',
  'GET /user/results': 'UserController.resultlist',
  'POST /user/applyCert/:id': 'UserController.applyCert',


  //****************Results routes************************/
  'GET /results/json': 'ResultsController.json',


  //****************Coach routes*************************/
  'GET /coach/passFail/:id': 'CoachController.passFail',
  'POST /coach/passFail/:id': 'CoachController.passFail',
  'GET /coach/passFail': 'CoachController.passFail',
  'GET /coach/endCourseList': 'CoachController.endList',
  'GET /coach/uploadDoc': 'CoachController.uploadDoc',
  'GET /coach/uploadDoc/:id': 'CoachController.uploadDoc',
  'POST /coach/upload': 'FileController.upload',
  'POST /coach/upload/:id': 'FileController.upload',
  'GET /coach/export_xlsx': 'CoachController.export_xlsx',
  '/coach/export_xlsx': 'CoachController.export_xlsx',

    //********************Receipt routes****************
    'GET /receipt/:id': 'ReceiptController.create',
    'POST /receipt/:id': 'ReceiptController.create',
    'GET /receipt/json': 'ReceiptController.json',
    '/receipt/delete/:id': 'ReceiptController.delete',
    '/receipt/showAll': 'ReceiptController.showAll',
